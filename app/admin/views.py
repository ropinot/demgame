# -*- coding: utf-8 -*-
from flask import render_template, Response, redirect, url_for, flash, request, g, jsonify, session
from flask.ext.login import login_user, logout_user, login_required, current_user
from sgapp import app, db
from sgapp.models import Scenario, Player, ScenarioCounter, ScenarioDemand, Supplier, ProductGoodwillCost, PlayerResult
...
from admin_functions import set_scenario_status, get_new_scenario_code
from sgapp.game_functions import tick, get_scenario_id, admin_required
...
def admin_login_view():
    ...
    # return Response('<p>Login admin</p>')
